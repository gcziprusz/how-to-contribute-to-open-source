...
<details>
<summary>
<strong> Olvasd el ezt az útmutatót más nyelveken </strong>
</summary>
    <ul>
...
# Légy üdvözölve kezdő nyílt forrás kód közreműködő!
[![lehívási kérelmeket szívesen látjuk](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat)](http://makeapullrequest.com)
...
Ez az erőforrások listája azoknak az embereknek, akik újonnan járultak hozzá a nyílt forráskódhoz.

Ha további forrásokat találsz, kérjük, küldj lehívási kérelmet.

Ha kérdésed vagy megjegyzésed van, hozz létre egy problémát.

**Tartalom**

- [Általános infó nyílt forráskód hozzájárulásához](#általános-infó-nyílt-forráskód-hozzájárulásához)
...
## Általános infó nyílt forráskód hozzájárulásához
